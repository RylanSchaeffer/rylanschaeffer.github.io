...
// toddmotto.com/mastering-svg-use-for-a-retina-web-fallbacks-with-png-script#update
  Drupal.behaviors.ucdOneReplaceSVG = {
    attach: function () {
      if (!Modernizr.svg) {
...
// Default text for search bar
  Drupal.behaviors.ucdOnePlaceholder = {
  ...
  // Throw a warning when trying to delete a node
  Drupal.behaviors.ucdOneDeleteNode = {
    attach: function (context) {
      $('.pane-node-form-buttons #edit-delete', context).click(function (e) {
        var confirm_box = confirm('Delete?! Are you sure you want to leave this page to delete everything?');
  ...
  // Turn select lists into nice Bootstrap styled pickers
  Drupal.behaviors.ucdOneBootstrapSelect = {
    attach: function (context) {
      $('select', context).once().selectpicker();
    }
  };

  // Apply sibling grid classes to Panels IPE wrappers
  Drupal.behaviors.ucdOnePanelsIPESiblingGrid = {
    attach: function (context) {
      // Half
      $('.l-sibling-grid--half', context).once().each(function () {
        $(this).closest('.panels-ipe-portlet-wrapper').addClass('ipe-sibling-grid l-sibling-grid--half');
      });

      // Third
      $('.l-sibling-grid--third', context).once().each(function () {
        $(this).closest('.panels-ipe-portlet-wrapper').addClass('ipe-sibling-grid l-sibling-grid--third');
      });
    }
  };
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    var $title = $('.anti-accordion__title');

    $title.on("click", function (e) {
      e.preventDefault();
      e.stopPropagation();
      $(this)
      .toggleClass("anti-accordion__title--open anti-accordion__title--closed")
      .next()
      .slideToggle(300);
    });
    ...
    var menuSwitch = function () {
      ...
      if (Modernizr.mq(bp_medium_up) || legacy) {
        ...
        if (!$menu_navbar.hasClass('is-horizontal')) {
          ...
          // Show submenus (not cached because menu can be ajaxed in)
          $menu.find('.menu ul.menu').show();
          // Hide Lower submenus
          $menu.find('.menu .menu ul.menu').hide();
      ...
      // Mobile
        ...
        if (!$menu_navbar.hasClass('is-vertical')) {
          ...
          // Hide submenus
          $menu.find('.menu ul.menu').hide();
          // Remove hover bind
          $menu.off('mouseenter mouseleave');
          // Remove the mobile submenu toggle class
          $menu.find('.submenu-toggle').removeClass('submenu-toggle--open');
        }
      }
    };
...
(function ($, window) {
  ...
  $(document).ready(function () {
    ...
    $('.search-popup__submit').on('click', function (e) {
      ...
      // People
      if (type === 'People') {
        url = '//directory.ucdavis.edu/cgi-bin/directory_results.shtml?filter=';
      }
      ...
      // Pages - redirect to the main site if this is not a Drupal site
        ...
        url = '//www.ucdavis.edu/search/google/';
      }
